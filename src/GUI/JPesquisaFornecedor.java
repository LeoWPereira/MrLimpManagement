...
public class JPesquisaFornecedor extends JPanel {
	 ...
	 */
	public JPesquisaFornecedor() throws ParseException
	{
		/*
		...
		final JComboBox<String> comboBoxSelecionaFornecedor = new JComboBox<String>();
		comboBoxSelecionaFornecedor.setModel(new DefaultComboBoxModel<String>(new Vector<String>(carregaListaFornecedores())));
		comboBoxSelecionaFornecedor.setBackground(new Color(222, 184, 135));
		comboBoxSelecionaFornecedor.setBounds(76, 11, 295, 20);
		panelInfoGerais.add(comboBoxSelecionaFornecedor);
		...
		final JFormattedTextField formattedTextFieldCNPJ = new JFormattedTextField(ftmCNPJ);
		...
		formattedTextFieldCNPJ.setBounds(76, 90, 180, 20);
		...
		buttonSelecionar.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				try
		        {
		            ...
		            String nome = comboBoxSelecionaFornecedor.getSelectedItem().toString();

		            java.sql.ResultSet rs = ctrl.consultar(criaSTMFornecedor(), nome);

		            while(rs.next())
		            {
		                textFieldNome.setText(rs.getString("nome"));
		                formattedTextFieldCNPJ.setText(rs.getString("cnpj"));
		            ...
		            comboBoxSelecionaFornecedor.setEnabled(false);
		        }
		...
		btnNovaConsulta.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				try
		        {
		            comboBoxSelecionaFornecedor.setEnabled(true);
			...
			public void actionPerformed(ActionEvent e)
			{
		        ...
		        try
		        {
		           ...
		           int resposta = JOptionPane.showOptionDialog(null, "Você está certo disso?", "",   
		            ...
		            {
		                ctrl.excluir(criaSTMFornecedor(), nome);
		...
		buttonSalvar.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				try
		        {
					...
					{
						String nome_anterior = comboBoxSelecionaFornecedor.getSelectedItem().toString();
			            
			            ctrl.alterar(criaSTMFornecedor(), nome_anterior, textFieldNome.getText(), textPaneObs.getText(), formattedTextFieldTelefone.getText(), formattedTextFieldCelular.getText(), textFieldEmail.getText(), formattedTextFieldCEP.getText(), textFieldBairro.getText(), textFieldCidade.getText(), textFieldRua.getText(), textFieldComplemento.getText(), comboBoxEstado.getSelectedItem().toString(), textFieldNumero.getText(), formattedTextFieldCNPJ.getText());
	...
	/**
	 * Método para carregar todos os fornecedores do Banco de Dados
	 * @return 
	 */
	@SuppressWarnings("unchecked")
	public List<String> carregaListaFornecedores()
	{
		try
        {
            CtrlFornecedor ctrl = new CtrlFornecedor();
            ...
            lista = ctrl.carregaJListFornecedor(criaSTMFornecedor());
	 ...
	 */
	public Statement criaSTMFornecedor() throws SQLException
	{
