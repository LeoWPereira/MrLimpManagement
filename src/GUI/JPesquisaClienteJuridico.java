...
public class JPesquisaClienteJuridico extends JPanel {
	 ...
	 */
	public JPesquisaClienteJuridico() throws ParseException
	{
		/*
		...
		comboBoxSelecionaCliente.setModel(new DefaultComboBoxModel<String>(new Vector<String>(carregaListaClientesJuridicos())));
	...
	public List<String> carregaListaClientesJuridicos()
	{
		try
        {
            CtrlCliente ctrl = new CtrlCliente();
            ...
            lista = ctrl.carregaJListClienteJuridico(criaSTMCliente());
