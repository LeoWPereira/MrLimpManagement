...
public class JCadastroClienteFisico extends JPanel {
	 ...
	 */
	public JCadastroClienteFisico() throws ParseException
	{
		/*
		...
		textFieldRG.setBounds(76, 40, 180, 20);
		panelInfoGerais.add(textFieldRG);
		
		JLabel lblCpf = new JLabel("CPF:");
		lblCpf.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblCpf.setBounds(325, 40, 46, 14);
		...
		formattedTextFieldCPF.setBounds(399, 40, 180, 20);
